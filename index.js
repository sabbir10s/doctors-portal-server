...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.sjp4o.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
    ...
    try {
        ...
        app.get('/available', async (req, res) => {
            ...
            services.forEach(service => {
                ...
                // step 4: fiend booking for that service.  output: [{}, {}, {}]
